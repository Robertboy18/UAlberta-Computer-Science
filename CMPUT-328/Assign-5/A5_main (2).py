...
def main():
    ...
    valid_dataloader = torch.utils.data.DataLoader(valid_set, batch_size=params.valid_batch_size, sampler=valid_sampler,
                                                   num_workers=train_params.n_workers)
    test_dataloader = torch.utils.data.DataLoader(test_set, batch_size=params.test_batch_size, shuffle=False,
                                                  num_workers=train_params.n_workers)
